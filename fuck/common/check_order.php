...
if(isset($_GET['need_check_list'])){
	...
	//	收件人/电话/地址/运费/消费税/积分
	if($field_name == 'receive_name' or $field_name == 'order_tax' or $field_name == 'pay_money' or $field_name == 'phone' or $field_name == 'buyer_email' or $field_name == 'shipping_price' or $field_name == 'payment_method' or $field_name == 'points' or $field_name == 'coupon'){
		echo 'ok';
	}
